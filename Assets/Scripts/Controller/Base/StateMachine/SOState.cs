...
{
	public abstract class SOState : ScriptableObject
	{

	}
	public abstract class SOState<T> : SOState, IState<T> where T : UnityEngine.Object
	{
		protected T actor;
...
// Example usage as ScriptableObject
//using RocketWorks.State;
//using System;
//using UnityEngine;

//[CreateAssetMenuAttribute]
//public class IdleState : SOState<Player> {
//  Init bla bla 
//}
